...
if (jquery__WEBPACK_IMPORTED_MODULE_2___default()("input[name='CRAFT_CSRF_TOKEN']").length > 0) {
  jquery__WEBPACK_IMPORTED_MODULE_2___default()(function () {
    jquery__WEBPACK_IMPORTED_MODULE_2___default.a.ajax({
      url: "/get-token",
      success: function success(response) {
        jquery__WEBPACK_IMPORTED_MODULE_2___default()("input[name='CRAFT_CSRF_TOKEN']").val(response);
      }
    });
  });
}
...
jquery__WEBPACK_IMPORTED_MODULE_2___default()(".jsClickForHref").css("cursor", "pointer").on("click", function (evt) {
...
__webpack_require__(/*! /Users/nts/0-Repositories/github-projects/web-app-starter/src/js/theme.js */"./src/js/theme.js");
module.exports = __webpack_require__(/*! /Users/nts/0-Repositories/github-projects/web-app-starter/src/css/theme.scss */"./src/css/theme.scss");
